...
class LeaderElectionPhase:
    ...
    def _2_single_leader_verification(self):
    ...
    def _4_rloc16_stability(self, delay=5):
    ...
    def _5_ipv6_address_stability(self, delay=5):
    ...
    def _6_state_stability(self, delay=5):
        def capture():
            return {
    ...
    def _7_routing_message_silence(self, delay=5):

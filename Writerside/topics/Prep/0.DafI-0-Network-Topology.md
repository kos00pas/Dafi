...
|      |                     |                                           |
| FTD  | Nordic (nRF52840)   | FED (Full End Device - always an ED,)     |
| FTD  | Nordic (nRF52840)   | REED ( End Device, can upgrade to Router) |
|      |                     |                                           |
| FTD  | Texas (CC2652)      | FED (Full End Device - always an ED,)     |
| FTD  | Texas (CC2652)      | REED ( End Device, can upgrade to Router) |
|      |                     |                                           |
| FTD  | Silicon (EFR32MG21) | FED (Full End Device - always an ED,)     |
| FTD  | Silicon (EFR32MG21) | REED ( End Device, can upgrade to Router) |
